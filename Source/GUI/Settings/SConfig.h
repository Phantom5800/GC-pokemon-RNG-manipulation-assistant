...
public:
  ...
  int getMinAtkIv(const GUICommon::starter starter, int idx) const;
  int getMinDefIv(const GUICommon::starter starter, int idx) const;
  int getMinSpAtkIv(const GUICommon::starter starter, int idx) const;
  int getMinSpDefIv(const GUICommon::starter starter, int idx) const;
  int getMinSpeedIv(const GUICommon::starter starter, int idx) const;
  ...
  void setMinAtkIv(const GUICommon::starter starter, const int minAtkIv, int idx);
  void setMinDefIv(const GUICommon::starter starter, const int minDefIv, int idx);
  void setMinSpAtkIv(const GUICommon::starter starter, const int minSpAtkIv, int idx);
  void setMinSpDefIv(const GUICommon::starter starter, const int minSpDefIv, int idx);
  void setMinSpeedIv(const GUICommon::starter starter, const int minSpeedIv, int idx);
